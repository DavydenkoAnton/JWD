...
public class GetPetsByTypeCommand implements by.davydenko.petbook.controller.command.Command {
    private static final Logger logger = LogManager.getLogger(GetPetsByTypeCommand.class);
    private static final String PETS_PAGE_URL = "http://localhost:8080/pb/pets.html";
    PetService petService;

    public GetPetsByTypeCommand(){
