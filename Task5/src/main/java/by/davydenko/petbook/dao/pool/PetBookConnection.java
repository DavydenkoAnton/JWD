...
public class PetBookConnection implements Connection, Comparable<PetBookConnection> {

    private Connection connection;

    public PetBookConnection(Connection connection) {
    ...
    @Override
    public int compareTo(PetBookConnection connection) {
